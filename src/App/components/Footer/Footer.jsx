import { LogoGithub, LogoLinkedin, Email, LogoInstagram, Phone} from '@carbon/icons-react'
import './Footer.css'
import { motion } from 'framer-motion'
export default function Footer()
{
    return(
        <motion.div layout="position" id="footer">
            <div id='footer-links'>
                <a href='https://www.linkedin.com/in/anirudh-ravipati-13541bb5/' target="_blank">
